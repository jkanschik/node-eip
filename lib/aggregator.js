...
var IntervallEmitter = function(i) {
	console.log("Creating intervall emitter with intervall ", i);
	this.intervall = i;
...
//		console.log("Executing intervall emitter")
		self.aggregator.emitAll();
	}, i);
};

IntervallEmitter.prototype.shutDown = function() {
...
var Emitter = {
	IntervallEmitter: IntervallEmitter
};
...
Aggregator.prototype.init = function(options) {
	...
	if (!this.options.emitter) {
		this.options.emitter = new IntervallEmitter(1000);
	}
...
Aggregator.prototype.shutDown = function() {
	...
	Aggregator.super_.prototype.shutDown();
};
